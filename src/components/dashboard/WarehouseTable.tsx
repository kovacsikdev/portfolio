          ...
          <tbody className="text-white divide-y divide-gray-200 bg-gray-900 divide-gray-700">
            {data.map((user) => (
              <tr key={user.ID} className="hover:bg-gray-100 hover:bg-gray-800">
                ...
                <td className="p-4 py-4800 text-sm">{user.Warehouse_block}</td>
                <td className="p-4 py-4800 text-sm">
                  {user.Product_importance}
                </td>
                <td className="p-4 py-4800 text-sm">{user.Mode_of_Shipment}</td>
                <td className="p-4 py-4800 text-sm">
                ...
                <td className="p-4 py-4800 text-sm">{convertNumToCommas(user.Prior_purchases)}</td>
              </tr>
            ))}
          </tbody>
        </table>
